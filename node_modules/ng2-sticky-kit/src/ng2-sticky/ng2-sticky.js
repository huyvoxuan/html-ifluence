...
var StickyComponent = (function () {
    ...
    StickyComponent.prototype.unstuckElement = function () {
        ...
        Object.assign(this.elem.style, {
            ...
            top: 'auto',
            left: 'auto',
            right: this.getCssValue(this.elem, 'float') === 'right' || this.float === 'right' ? 0 : 'auto',
...
__decorate([
    core_1.Input('sticky-float'),
    __metadata("design:type", String)
], StickyComponent.prototype, "float", void 0);
__decorate([
    core_1.Output(),
...
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
], StickyComponent.prototype, "reset", void 0);
__decorate([
...
], StickyComponent.prototype, "onChange", null);
